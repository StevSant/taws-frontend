...
export const ES_TRANSLATIONS = {
  ...
  'agents.subtitle':
    'Un supervisor, seis especialistas. Cada uno tiene un rol, herramientas y una personalidad.',
  'agents.ask': 'Preguntá sobre',
  'agents.exampleLabel': 'Ejemplo de prompt',
  'agents.kind.router': 'Agente ruteador',
  'agents.kind.specialist': 'Agente especialista',
  'agents.role.supervisor': 'Supervisor',
  'agents.role.analyst': 'Analista',
  'agents.role.quant': 'Quant',
  'agents.role.macro': 'Macro',
  'agents.role.sentiment': 'Sentimiento',
  'agents.role.consequence': 'Consecuencias',
  'agents.role.advisor': 'Asesor',
  'agents.example.supervisor': '¿Qué está haciendo el mercado hoy?',
  'agents.example.analyst': 'Analizá los resultados de {symbol}',
  'agents.example.quant': 'Compará ratios Sharpe de {symbol}',
  'agents.example.macro': 'Contexto macro actual',
  'agents.example.sentiment': 'Sentimiento sobre {sector}',
  'agents.example.consequence': '¿Qué pasa si las tasas suben 50pb?',
  'agents.example.advisor': '¿Debería comprar {symbol}?',
  'chat.error.banner': 'No se pudo enviar el mensaje',
  'chat.welcome.title': 'Bienvenido a Midas',
  'chat.welcome.subtitle': 'Radar financiero multiagente',
  'chat.welcome.purpose': 'Preguntá cualquier cosa sobre mercados, activos o tu portfolio.',
  'chat.suggestion.quant': 'Sugerí factores quant para {symbol}',
  'chat.suggestion.news': 'Resumí las últimas noticias sobre {symbol}',
  'chat.suggestion.macro': '¿Cómo afecta el macro a {sector}?',
  'chat.suggestion.compare': 'Compará {symbol1} y {symbol2}',
  'chat.auth.signInPrompt': 'Iniciá sesión para empezar a conversar',
  'chat.voice.hint': 'El modo de voz es experimental',
  'chat.tts.play': 'Leer en voz alta',
  'chat.tts.stop': 'Detener',
  'chat.tts.speaking': 'Hablando…',
  'chat.tts.error': 'La síntesis de voz falló',
  'chat.stt.start': 'Iniciar entrada de voz',
  'chat.stt.stop': 'Detener',
