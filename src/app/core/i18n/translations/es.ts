...
export const ES_TRANSLATIONS = {
  ...
  'chat.welcome.title': 'Preguntale a la flota Midas',
  'chat.welcome.subtitle':
    'El Supervisor enruta tu pregunta al Analista, Quant, Asesor y otros especialistas — mirá la traza de agentes mientras trabajan.',
  ...
  'chat.oracle.status.idle': 'Oráculo listo',
  ...
  'radar.description':
    'Noticias financieras agrupadas por activo. Cada tarjeta muestra el titular principal, movimientos de precio y — tras ejecutar Analyst — el impacto esperado.',
  ...
  'radar.generate.action': 'Ejecutar Analyst',
  'radar.generate.generating': 'Analizando…',
  'radar.generate.hint': 'La IA lee las noticias del activo y estima si el impacto es positivo, negativo o incierto.',
  ...
  'radar.landscape.unclassified': 'Pendiente Analyst',
  ...
  'radar.card.status.pending': 'Pendiente — ejecutá Analyst',
  ...
  'radar.review.title': 'Revisión compliance',
  ...
  'watchlist.manager.title': 'Gestionar watchlists',
  'watchlist.manager.create': 'Crear watchlist',
  'watchlist.manager.namePlaceholder': 'Nombre de la watchlist',
  'watchlist.manager.addSymbol': 'Agregar símbolo',
  'watchlist.manager.symbolPlaceholder': 'ej. AAPL',
  'watchlist.manager.delete': 'Eliminar',
  'watchlist.manager.emptyItems': 'Sin símbolos — agregá tickers a esta watchlist.',
  ...
  'notifications.radar.signalGenerated': 'Señal del Analyst generada',
  'notifications.briefing.generated': 'Nuevo briefing generado',
