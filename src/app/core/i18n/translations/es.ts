...
export const ES_TRANSLATIONS = {
  ...
  'shell.nav.markets.hint': 'Explora todos los activos con filtros y señales',
  'shell.nav.chat': 'Chat',
  ...
  'user.description': 'Perfil, preferencias y sesión activa en Midas.',
  'user.menu.profile': 'Ver perfil completo',
  'user.section.account': 'Cuenta',
  'user.section.preferences': 'Preferencias',
  'user.field.displayName': 'Nombre para mostrar',
  ...
  'chat.stt.error': 'No se pudo transcribir tu voz.',
  'chat.stt.unavailable': 'El dictado por voz no está disponible en este navegador.',
  'chat.realtime.talk': 'Hablar con el agente',
  'chat.realtime.talkCta': 'Hablar con Midas',
  'chat.realtime.stop': 'Finalizar sesión de voz',
  'chat.realtime.end': 'Terminar',
  'chat.realtime.close': 'Cerrar modo de voz',
  ...
  'chat.realtime.transcriptEmpty': 'Acá va a aparecer tu conversación.',
  ...
  'radar.detail.asset.loading': 'Cargando instrumento…',
  'radar.detail.asset.notFound.title': 'Instrumento no encontrado',
  'radar.detail.asset.notFound.description':
    'Este símbolo no está en el universo monitoreado. Vuelve al radar para explorar los instrumentos seguidos.',
  'radar.detail.asset.priceChart': 'Precio',
  'radar.detail.stats.lastPrice': 'Último precio',
  'radar.detail.stats.priceDelta': 'Δ Precio',
  'radar.detail.stats.volatility': 'Volatilidad',
  'radar.detail.stats.regime': 'Régimen de volatilidad',
  'radar.detail.relatedNews': 'Noticias relacionadas',
  'radar.detail.relatedNews.empty': 'No hay noticias relacionadas en la ventana reciente.',
  'radar.detail.watchlist.add': 'Añadir a la watchlist',
  'radar.detail.watchlist.remove': 'Quitar de la watchlist',
  'radar.detail.watchlist.busy': 'Guardando…',
  'radar.detail.watchlist.signInHint': 'Inicia sesión para usar watchlists',
  'radar.detail.watchlist.error': 'No se pudo actualizar la watchlist:',
  'radar.detail.watchlist.defaultName': 'Mi watchlist',
  ...
  'notes.panel.add': 'Agregar',
  'notes.panel.save': 'Guardar',
  'notes.panel.cancel': 'Cancelar',
  'notes.panel.edit': 'Editar',
  'notes.panel.delete': 'Eliminar',
  'notes.panel.empty': 'Todavía no tenés notas. Agregá la primera arriba.',
  'notes.panel.loading': 'Cargando notas…',
  'notes.panel.signIn': 'Iniciá sesión para crear y guardar tus notas.',
  'notes.panel.error': 'No pudimos guardar tus notas. Volvé a intentarlo.',
  ...
  'watchlist.manager.symbolUnknown':
    'Ese símbolo no está en el universo de instrumentos. Elegí uno de las sugerencias.',
  'watchlist.manager.symbolDuplicate': 'Ese símbolo ya está en esta lista.',
  'briefings.prep.progress': 'Preparando análisis',
  ...
  'notifications.open': 'Ver detalle',
