...
export const ES_TRANSLATIONS = {
  ...
  'shell.nav.watchlists': 'Listas',
  'shell.nav.watchlists.hint': 'Creá y organizá tus listas de seguimiento',
  'shell.nav.notes': 'Notas',
  'shell.nav.notes.hint': 'Tu bloc de notas personal y privado',
  ...
  'boardroom.title': 'Consejo de agentes',
  'boardroom.synthesizer': 'Síntesis',
  'boardroom.status.consulting': 'Consultando…',
  'boardroom.status.usingTool': 'Usando',
  'boardroom.status.done': 'Listo',
  'boardroom.status.synthesizing': 'Sintetizando…',
  'verdict.title': 'Veredicto alcista / bajista',
  'verdict.bearish': 'Bajista',
  'verdict.lean-bearish': 'Ligeramente bajista',
  'verdict.mixed': 'Mixto',
  'verdict.lean-bullish': 'Ligeramente alcista',
  'verdict.bullish': 'Alcista',
  'verdict.dissent': 'En desacuerdo:',
  ...
  'radar.news.scope.label': 'Alcance de las noticias',
  'radar.news.scope.mine': 'Mis instrumentos',
  'radar.news.scope.market': 'Todo el mercado',
  'radar.news.scope.empty': 'Sin catalizadores para tus instrumentos.',
  'radar.news.scope.showMarket': 'Ver todo el mercado',
  ...
  'radar.movers.title': 'Mayores movimientos',
  'radar.movers.subtitle': 'Los activos que más se mueven en el mercado.',
  'radar.movers.gainers': 'Mayores subidas',
  'radar.movers.losers': 'Mayores bajadas',
  'radar.movers.empty': 'Sin datos de movimientos.',
  'radar.movers.loading': 'Cargando movimientos…',
  'radar.newsList.title': 'Todas las noticias',
  'radar.newsList.description':
    'Explora todas las noticias del mercado: filtra por tipo, activo, fuente, sentimiento y estado, busca por titular y ordénalas a tu gusto.',
  'radar.newsList.empty.title': 'Sin noticias',
  'radar.newsList.empty.description': 'No hay noticias para los filtros seleccionados.',
  'radar.newsFilters.search': 'Buscar',
  'radar.newsFilters.searchPlaceholder': 'Buscar en titulares…',
  'radar.newsFilters.source': 'Fuente',
  'radar.newsFilters.allSources': 'Todas las fuentes',
  'radar.newsFilters.provider': 'Proveedor',
  'radar.newsFilters.allProviders': 'Todos los proveedores',
  'radar.newsFilters.sentiment': 'Sentimiento',
  'radar.newsFilters.allSentiments': 'Todos los sentimientos',
  'radar.newsFilters.category': 'Categoría',
  'radar.newsFilters.allCategories': 'Todas las categorías',
  'radar.newsCategory.macro': 'Macro',
  'radar.newsCategory.earnings': 'Resultados',
  'radar.newsCategory.regulation': 'Regulación',
  'radar.newsCategory.crypto': 'Cripto',
  'radar.newsCategory.mergersAcquisitions': 'Fusiones y adquisiciones',
  'radar.newsCategory.geopolitics': 'Geopolítica',
  'radar.newsCategory.companyNews': 'Empresas',
  'radar.newsCategory.uncategorized': 'Sin categoría',
  'radar.newsFilters.status': 'Estado',
  'radar.newsFilters.allStatuses': 'Todos los estados',
  'radar.newsFilters.status.pending': 'Pendiente',
  'radar.newsFilters.status.analyzed': 'Analizada',
  'radar.newsFilters.status.skipped': 'Omitida',
  'radar.newsFilters.sortBy': 'Ordenar por',
  'radar.newsFilters.sort.date': 'Fecha',
  'radar.newsFilters.sort.source': 'Fuente',
  'radar.newsFilters.toggleOrder': 'Cambiar orden',
  'radar.subnav.label': 'Secciones del radar',
  'radar.subnav.radar': 'Radar',
  'radar.watchlists.title': 'Mis listas',
  'radar.watchlists.subtitle': 'Cómo viene cada lista tuya. Tocá una para abrir su detalle.',
  'radar.watchlists.manage': 'Gestionar',
  'radar.watchlists.create': 'Nueva lista',
  'radar.watchlists.empty.cta': 'Creá tu primera lista',
  'radar.watchlists.empty.hint': 'Agrupá los instrumentos que querés seguir juntos.',
  'radar.watchlists.instrument': 'instrumento',
  'radar.watchlists.instruments': 'instrumentos',
  'radar.watchlists.noInstruments': 'Lista vacía',
  'radar.watchlists.average': 'Promedio',
  'radar.watchlists.confidence': 'Confianza media',
  'radar.watchlists.unscored': 'Sin análisis todavía',
  'radar.watchlists.more': 'más',
  'radar.watchlists.viewDetail': 'Ver detalle',
  'radar.watchlists.viewAll': 'Ver todas',
  'radar.watchlists.filter': 'Filtrar radar',
  'radar.instruments.title': 'Instrumentos en seguimiento',
  'radar.instruments.titleFallback': 'Instrumentos destacados',
  ...
  'watchlists.detail.title': 'Detalle de lista',
  'watchlists.detail.back': 'Mis listas',
  'watchlists.detail.loading': 'Cargando lista…',
  'watchlists.detail.manage': 'Gestionar',
  'watchlists.detail.instruments': 'Instrumentos',
  'watchlists.detail.viewLink': 'Ver detalle',
  'watchlists.detail.outlook.title': 'Perspectiva histórica de la lista',
  'watchlists.detail.outlook.forward7d': 'Movimiento típico a 7 días',
  'watchlists.detail.outlook.forward30d': 'Movimiento típico a 30 días',
  'watchlists.detail.outlook.contributing': '{count} de {total} instrumentos con base histórica',
  'watchlists.detail.outlook.disclaimer':
    'Base histórica empírica: así se comportaron estos activos tras movimientos similares en el pasado. No es una predicción ni un objetivo de precio, y no constituye asesoramiento personalizado.',
  'watchlists.detail.outlook.empty': 'Todavía no hay base histórica suficiente para esta lista.',
  'watchlists.detail.member.similarMoves': 'Tras movimientos similares (n={count}):',
  'watchlists.detail.member.forward7dLabel': '7d',
  'watchlists.detail.member.range': 'rango',
  'watchlists.detail.member.probability': 'prob.',
  'watchlists.detail.member.confidence': 'Confianza',
  'watchlists.detail.notFound.title': 'Lista no encontrada',
  'watchlists.detail.notFound.description':
    'Esta lista no existe o ya no está disponible en tu cuenta.',
  'watchlists.detail.empty.title': 'Lista sin instrumentos',
  'watchlists.detail.empty.description':
    'Agrega instrumentos desde la página de gestión para ver el análisis y la perspectiva de la lista.',
  'watchlists.overview.subtitle': 'Todas tus listas, con la lectura del analista de cada una.',
  'watchlists.overview.create': '+ Crear lista',
  'watchlists.overview.empty.title': 'Todavía no tienes listas',
  'watchlists.overview.empty.description': 'Creá una para empezar a seguir instrumentos juntos.',
  'watchlists.overview.empty.cta': 'Creá tu primera lista',
  'watchlists.form.createTitle': 'Nueva lista',
  'watchlists.form.editTitle': 'Editar lista',
  'watchlists.form.nameLabel': 'Nombre de la lista',
  'watchlists.form.namePlaceholder': 'Nombre de la lista',
  'watchlists.form.instruments': 'Instrumentos',
  'watchlists.form.create': 'Crear lista',
  'watchlists.form.creating': 'Creando…',
  'watchlists.form.done': 'Listo',
  'watchlists.form.back': 'Volver',
  'watchlists.form.empty': 'Todavía no agregaste instrumentos.',
  'watchlists.detail.edit': 'Editar',
  'watchlists.detail.delete': 'Eliminar',
  'watchlists.detail.delete.confirm': '¿Eliminar esta lista?',
  'watchlists.detail.delete.cancel': 'Cancelar',
  'watchlists.detail.delete.confirmCta': 'Sí, eliminar',
  'watchlists.detail.outlook.forward24h': 'Movimiento típico a 24 h',
  ...
  'scenarios.dev.runWatchdog': 'Ejecutar watchdog ahora',
  'scenarios.dev.runningWatchdog': 'Ejecutando watchdog…',
  'notes.page.title': 'Mis notas',
  'notes.page.subtitle':
    'Notas personales visibles solo para tu cuenta. Podés vincularlas a un informe, escenario o activo.',
  ...
  'notes.target.briefing': 'Informe',
  'notes.target.scenario': 'Escenario',
  'notes.target.instrument': 'Activo',
  'notes.target.unavailable': 'ya no disponible',
  'notes.target.none': 'Sin vincular',
  'notes.trigger.add': 'Agregar nota',
  'notes.trigger.notes': 'notas',
  'notes.trigger.note': 'nota',
  'notes.drawer.about': 'Notas sobre',
  'notes.drawer.close': 'Cerrar',
  'notes.panel.errorTargetGone': 'Eso ya no existe: no se pudo guardar la nota.',
  'notes.page.filter.all': 'Todas',
  'notes.page.filter.linked': 'Vinculadas',
  'notes.page.filter.unlinked': 'Sin vincular',
  'notes.page.emptyFiltered': 'No hay notas en esta vista.',
  ...
  'notifications.scenario.matched': '⚡ Escenario materializándose',
