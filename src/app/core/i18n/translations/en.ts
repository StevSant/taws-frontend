...
export const EN_TRANSLATIONS = {
  ...
  'markets.empty.description': 'Adjust the search or asset-class filter.',
  'markets.error': 'Could not load the market: ',
  ...
  'notes.panel.empty': 'No notes yet. Add your first one above.',
  'notes.panel.loading': 'Loading notes…',
  'notes.panel.signIn': 'Sign in to create and save your notes.',
  'notes.panel.error': "We couldn't save your notes. Please try again.",
