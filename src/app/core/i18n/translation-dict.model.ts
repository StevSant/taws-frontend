...
export interface TranslationDict {
  ...
  'chat.realtime.roleUser': string;
  'chat.realtime.roleAssistant': string;
  ...
  'boardroom.title': string;
  'boardroom.synthesizer': string;
  'boardroom.status.consulting': string;
  'boardroom.status.usingTool': string;
  'boardroom.status.done': string;
  'boardroom.status.synthesizing': string;
  'verdict.title': string;
  'verdict.bearish': string;
  'verdict.lean-bearish': string;
  'verdict.mixed': string;
  'verdict.lean-bullish': string;
  'verdict.bullish': string;
  'verdict.dissent': string;
  ...
  'radar.news.scope.label': string;
  'radar.news.scope.mine': string;
  'radar.news.scope.market': string;
  'radar.news.scope.empty': string;
  'radar.news.scope.showMarket': string;
  ...
  'radar.movers.title': string;
  'radar.movers.subtitle': string;
  'radar.movers.gainers': string;
  'radar.movers.losers': string;
  'radar.movers.empty': string;
  'radar.movers.loading': string;
  ...
  'radar.newsFilters.search': string;
  'radar.newsFilters.searchPlaceholder': string;
  'radar.newsFilters.source': string;
  'radar.newsFilters.allSources': string;
  'radar.newsFilters.provider': string;
  ...
  'radar.newsFilters.status.analyzed': string;
  'radar.newsFilters.status.skipped': string;
  'radar.newsFilters.sortBy': string;
  'radar.newsFilters.sort.date': string;
  'radar.newsFilters.sort.source': string;
  'radar.newsFilters.toggleOrder': string;
  'radar.subnav.label': string;
  'radar.subnav.radar': string;
  'radar.watchlists.title': string;
  'radar.watchlists.subtitle': string;
  'radar.watchlists.manage': string;
  'radar.watchlists.create': string;
  'radar.watchlists.empty.cta': string;
  'radar.watchlists.empty.hint': string;
  'radar.watchlists.instrument': string;
  'radar.watchlists.instruments': string;
  'radar.watchlists.noInstruments': string;
  'radar.watchlists.average': string;
  'radar.watchlists.confidence': string;
  'radar.watchlists.unscored': string;
  'radar.watchlists.more': string;
  'radar.watchlists.viewDetail': string;
  'radar.watchlists.viewAll': string;
  'radar.watchlists.filter': string;
  'radar.instruments.title': string;
  'radar.instruments.titleFallback': string;
  ...
  'radar.detail.back.news': string;
  'radar.detail.back.markets': string;
  ...
  'watchlists.detail.title': string;
  'watchlists.detail.back': string;
  'watchlists.detail.loading': string;
  'watchlists.detail.manage': string;
  'watchlists.detail.instruments': string;
  'watchlists.detail.viewLink': string;
  'watchlists.detail.outlook.title': string;
  'watchlists.detail.outlook.forward7d': string;
  'watchlists.detail.outlook.forward30d': string;
  'watchlists.detail.outlook.contributing': string;
  'watchlists.detail.outlook.disclaimer': string;
  'watchlists.detail.outlook.empty': string;
  'watchlists.detail.member.similarMoves': string;
  'watchlists.detail.member.forward7dLabel': string;
  'watchlists.detail.member.range': string;
  'watchlists.detail.member.probability': string;
  'watchlists.detail.member.confidence': string;
  'watchlists.detail.notFound.title': string;
  'watchlists.detail.notFound.description': string;
  'watchlists.detail.empty.title': string;
  'watchlists.detail.empty.description': string;
  'watchlists.overview.subtitle': string;
  'watchlists.overview.create': string;
  'watchlists.overview.empty.title': string;
  'watchlists.overview.empty.description': string;
  'watchlists.overview.empty.cta': string;
  'watchlists.form.createTitle': string;
  'watchlists.form.editTitle': string;
  'watchlists.form.nameLabel': string;
  'watchlists.form.namePlaceholder': string;
  'watchlists.form.instruments': string;
  'watchlists.form.create': string;
  'watchlists.form.creating': string;
  'watchlists.form.done': string;
  'watchlists.form.back': string;
  'watchlists.form.empty': string;
  'watchlists.detail.edit': string;
  'watchlists.detail.delete': string;
  'watchlists.detail.delete.confirm': string;
  'watchlists.detail.delete.cancel': string;
  'watchlists.detail.delete.confirmCta': string;
  'watchlists.detail.outlook.forward24h': string;
  'watchlists.detail.window.24h': string;
  'watchlists.detail.window.7d': string;
  'watchlists.detail.window.30d': string;
  ...
  'telegram.testNews.send': string;
  'telegram.testNews.sending': string;
  'telegram.testNews.sent': string;
  ...
  'scenarios.dev.runWatchdog': string;
  'scenarios.dev.runningWatchdog': string;
  ...
  'notes.target.briefing': string;
  'notes.target.scenario': string;
  'notes.target.instrument': string;
  'notes.target.unavailable': string;
  'notes.target.none': string;
  'notes.trigger.add': string;
  'notes.trigger.notes': string;
  'notes.trigger.note': string;
  'notes.drawer.about': string;
  'notes.drawer.close': string;
  'notes.panel.errorTargetGone': string;
  'notes.page.filter.all': string;
  'notes.page.filter.linked': string;
  'notes.page.filter.unlinked': string;
  'notes.page.emptyFiltered': string;
  ...
  'notifications.scenario.matched': string;
