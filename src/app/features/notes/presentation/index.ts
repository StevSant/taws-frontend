...
export { NotesTriggerChipComponent } from './notes-trigger-chip/notes-trigger-chip.component';
export { noteTargetLink } from './note-target-link';
export type { NoteTargetLink } from './note-target-link';
